...
ALTER TABLE final_project_objet
ADD CONSTRAINT fk_objet_categorie FOREIGN KEY (id_categorie) REFERENCES categorie_objet(id_categorie);
ALTER TABLE final_project_objet
ADD CONSTRAINT fk_objet_membre FOREIGN KEY (id_membre) REFERENCES membre(id_membre);
ALTER TABLE final_project_images_objet
ADD CONSTRAINT fk_images_objet FOREIGN KEY (id_objet) REFERENCES objet(id_objet);
ALTER TABLE final_project_emprunt
ADD CONSTRAINT fk_emprunt_objet FOREIGN KEY (id_objet) REFERENCES objet(id_objet);
ALTER TABLE final_project_emprunt
ADD CONSTRAINT fk_emprunt_membre FOREIGN KEY (id_membre) REFERENCES membre(id_membre);
-- Insert 4 members
INSERT INTO final_project_membre (
        nom,
        date_naissance,
        genre,
        email,
...
INSERT INTO final_project_objet (nom_objet, id_categorie, id_membre)
VALUES ('Perceuse électrique', 2, 1),
    ('Scie circulaire', 2, 1),
    ('Marteau', 2, 1),
    ('Tournevis set', 2, 1),
    ('Pinceau set', 1, 1),
...
INSERT INTO final_project_objet (nom_objet, id_categorie, id_membre)
VALUES ('Miroir de maquillage', 1, 4),
...
INSERT INTO final_project_images_objet (id_objet, nom_image)
VALUES (1, 'perceuse.jpg'),
...
INSERT INTO final_project_emprunt (id_objet, id_membre, date_emprunt, date_retour)
VALUES (1, 2, '2023-01-15', '2023-01-20'),
...
SELECT o.id_objet,
    ...
    DATE_FORMAT(e.date_emprunt, '%b %e %Y') AS date_emprunt,
    DATE_FORMAT(e.date_retour, '%b %e %Y') AS date_retour
